package com.mobile.theftapp.utils;
...
/**
 * Cache for storing information in the disk or in the memory
 * Intended Objects should be Serializable
 * Base64 encryption is enabled by default 
 * 
 * Cache Location defaults to {@link CACHE_LOACATION_MEMORY}
 * </p>
 * Note: Data saved in memory will be wiped out after the application exists.
 * And avoid storing heavy objects in the Memory
 * </p>
 * Usage:</br>
 * Save data using {@link #putData(String, Context, Object, int)} </br>
 * Retrieve saved data from the memory using {@link #getDataFromMemory(String)}</br>
 * retrive saved data from the disk using {@link #getData(String, Context)}</br>
 * </br>
 * OR implement a map for the keys and their respective memory location</br>
 * </br>
 *
 */
public class TheftAppCache {
